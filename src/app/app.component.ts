...
export class AppComponent {
  ...
  Next up we add a HostBinding which can be used to add value to a property on the host element.
  ...
  to sanitize the HTML before we inject it into the element.
